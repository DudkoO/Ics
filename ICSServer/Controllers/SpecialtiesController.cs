...
namespace ICSServer.Controllers
{
    public class SpecialtiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,SpecialtyCode,SpecialtyNumberCode,Name")] Specialty specialty)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,SpecialtyCode,SpecialtyNumberCode,Name")] Specialty specialty)
        {
            if (id != specialty.Id)
            {
                return NotFound();
